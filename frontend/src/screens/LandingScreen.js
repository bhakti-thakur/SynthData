          ...
          setLoginVisible(true);}} /> */}
                ...
                <View style={styles.topSection}>
                    ...
                    <View style={styles.diagramContainer}>
                        <Image
                            source={require('../../assets/images/data-generation-process-diagram.png')}
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.processFlowchart}>
                        <View style={styles.processItem}>
                            <Image
                                source={require('../../assets/images/dataset-icon.png')}
                        ...
                        <View style={styles.processItem}>
                            <Image
                                source={require('../../assets/images/gear-funnel-icon.png')}
                                style={styles.processIcon}
                                resizeMode="contain"
                            />
                        ...
                        <View style={styles.processItem}>
                            <Image
                                source={require('../../assets/images/brain-gear-icon.png')}
                                style={styles.processIcon}
                                resizeMode="contain"
                            />
                        ...
                        <View style={styles.processItem}>
                            <Image
                                source={require('../../assets/images/chip-icon.png')}
                                style={styles.processIcon}
                                resizeMode="contain"
                            />
                        ...
                        <View style={styles.processItem}>
                            <Image
                                source={require('../../assets/images/analyst-icon.png')}
                                style={styles.processIcon}
                                resizeMode="contain"
                            />
